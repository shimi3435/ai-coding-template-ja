...
cycle 1のcommandのsource commitは `80d0bb7bc445e11de4e6dfff744f5add574f44b3` とその作業差分。cycle 2は `ae2cc0e` とその作業差分。各taskにfresh/再利用、結果、未検証理由だけを追記する。PR作成・merge・外部resource操作は対象外のままとする。
