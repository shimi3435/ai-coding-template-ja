...
- 2026-09-25 simplify-skill-ownership-and-lock（PR #81）: 逃した欠陥 8 件（self-review=5 / review=2 / CI=1 / merge後=0）— metadata境界・空移行・repin表示・取得前拒否・tracked legal照合を修正し、Ubuntu / WSL検証と独立verifierを通過
